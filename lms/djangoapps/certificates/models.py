...
def certificate_info_for_user(user, course_id, grade, user_is_whitelisted=None):
    ...
    user_is_embargoed = user.profile.allow_certificate is False
    eligible_for_certificate = not user_is_embargoed and (user_is_whitelisted or grade is not None)
    ...
    if eligible_for_certificate:
        ...
        certificate_is_delivered = 'Y' if not user_is_embargoed and (user_is_whitelisted or certificate_generated) else 'N'  # pylint: disable=line-too-long
